<?php
namespace OrderExt\Orderext\Tests\Unit\Controller;
...
{
    /**
     * @var \OrderExt\Orderext\Controller\OrderController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\OrderExt\Orderext\Controller\OrderController::class)
    ...
    public function listActionFetchesAllOrdersFromRepositoryAndAssignsThemToView()
    {
        ...
        $orderRepository = $this->getMockBuilder(\OrderExt\Orderext\Domain\Repository\OrderRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $order = new \OrderExt\Orderext\Domain\Model\Order();
